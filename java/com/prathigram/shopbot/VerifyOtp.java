...
public class VerifyOtp extends AppCompatActivity {
                ...
                .addOnCompleteListener(VerifyOtp.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            addStatusToDb();
                            Toast.makeText(VerifyOtp.this, "Otp Verified",Toast.LENGTH_LONG).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlC, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.trim().equalsIgnoreCase("success"))
                {
                    ...
                    Intent registerIntent = new Intent(VerifyOtp.this, Profile.class);
    ...
    public void onBackPressed() {
        Intent nl = new Intent(VerifyOtp.this, MainActivity.class);
        startActivity(nl);
        finish();
